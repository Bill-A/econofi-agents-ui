    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
      ...
      <section className="space-y-4">
        <h1 className="text-3xl sm:text-4xl font-bold text-[#13204c] tracking-tight leading-tight">
          ...
          <span className="text-[#0d7a6b]">automated for community banks.</span>
        </h1>
        <p className="text-[17px] text-[#3d4557] leading-relaxed max-w-2xl">
          Econofi's TransactionMonitor detects BSA/AML patterns automatically — structuring, velocity anomalies,
          round-dollar transfers, and geographic risk. Every alert carries a regulatory citation, risk score, and
          recommended action. Your BSA Officer works investigations, not pattern-matching.
        </p>
      ...
      {/* How to use */}
      <section>
        <h2 className="text-xl font-bold text-[#13204c] mb-2">How to use this app</h2>
        <p className="text-sm text-[#3d4557] mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {steps.map((step) => (
            ...
            >
              ...
              <h3 className="text-base font-bold text-[#13204c] mb-2 group-hover:text-[#0d7a6b] transition-colors">
                {step.title}
              </h3>
              <p className="text-sm text-[#3d4557] leading-relaxed">{step.description}</p>
            </Link>
          ))}
        </div>
      </section>
