...
const steps = [
  ...
  },
  {
    ...
    toolUrl: 'localhost:3000/alerts',
    heading: 'Transition to the investigation queue',
    actions: [
      'Switch to the localhost:3000/alerts tab.',
  ...
  },
  {
    ...
    actions: [
      ...
      'Show the status filter — Pending, In Progress, SAR Filed.',
      'Click "Investigate" on ALT-2026-05-04-00001 (the structuring alert — matches what you just showed in TransactionMonitor).',
    ],
    lookFor: [
      '4 alerts in the queue — structuring, velocity anomaly, geographic risk, round dollar.',
  ...
  },
  {
    time: '3:45 – 4:45',
    tool: 'Alert Detail',
    toolUrl: 'localhost:3000/alerts/ALT-2026-05-04-00001',
    heading: 'Investigate and generate the SAR narrative',
    actions: [
      'Walk the suspicious indicators and regulatory citation.',
      ...
      'Enter a SAR reference number in the field that appears.',
    ],
    lookFor: [
      'Narrative is pre-populated from the alert data — same content as TransactionMonitor, now inside the officer\'s workflow.',
      'Bank/CU toggle changes the MDI context paragraph in the narrative — same differentiator, different surface.',
      'SAR reference number field — this is how the officer closes the loop and records the FinCEN submission.',
    ],
  },
  {
    time: '4:45 – 5:00',
